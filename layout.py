    ...
    def setbg(self):
        ...
        if self.person == "Yes":
            if scale > 0.65:
                bg = np.zeros((self.screenheight + self.margin * 2, int(self.screenwidth * 4 / 3) + self.margin * 3, 3),
                              np.uint8)
                print(str(scale) + ' Stand screen with person -> 4:3')
                ...
                bg = np.zeros((self.screenheight + self.margin * 2, int(self.screenwidth * 5 / 4) + self.margin * 3, 3),
                              np.uint8)
                print(str(scale) + ' Widescreen with person -> 16:9')
                screenroi = (self.screenwidth, self.screenheight)
        ...
        if self.person == "No":
            if scale > 0.65:
                ...
                print(str(scale) + ' Stand screen without person -> 4:3')
                screenroi = (self.screenwidth, self.screenheight)
                personroi = None
            else:
                bg = np.zeros((self.screenheight + self.margin * 2, self.screenwidth + self.margin * 2, 3), np.uint8)
                print(str(scale) + ' Widescreen without person -> 16:9')
                screenroi = (self.screenwidth, self.screenheight)
                personroi = None
